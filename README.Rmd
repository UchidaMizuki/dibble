...
The columns of the dibbles are classified into dimensions or metrics, and the operations on the metrics are broadcasted.
...
`dibble()` allows broadcasting based on the union set of axes of multiple dibbles (or metrics).
